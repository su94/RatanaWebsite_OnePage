...
const services = {
  en: [
    ...
    },
    {
      ...
      description:
        "Planning and executing press conferences, product launches, and media events. We handle all logistics and media coordination to ensure successful coverage.",
    },
    {
      title: "Media Training and Preparation",
      description:
        "Professional training sessions for spokespersons, preparing them for media interviews and public appearances with comprehensive briefings and practice.",
    },
    {
      title: "Consultation Services",
      description:
        "Expert consultation on media strategy, brand positioning, and communication planning to help achieve your organizational objectives.",
    },
  ],
  ar: [
    {
      ...
      description:
        "صياغة بيانات صحفية مؤثرة تنقل رسائلك الرئيسية والأحداث الإخبارية بفعالية. نقوم أيضاً بتصميم حقائب إعلامية شاملة تزود الصحفيين بجميع المعلومات والمواد اللازمة.",
    },
    {
      title: "التواصل الإعلامي وبناء العلاقات",
      description:
        "إنشاء وتعزيز علاقات قوية مع وسائل الإعلام الرئيسية والصحفيين. نقوم بطرح القصص بشكل استباقي وضمان التغطية الإعلامية في المنشورات والبث الإذاعي الرائد.",
    },
    {
      title: "المراقبة وإعداد التقارير",
      description:
        "مراقبة مستمرة للتغطية الإعلامية والرأي العام المتعلق بمؤسستك. نقدم تقارير وتحليلات مفصلة لتتبع فعالية الاستراتيجيات الإعلامية وتحديد فرص التحسين.",
    },
    {
      title: "الإنتاج الإعلامي",
      description:
        "إنتاج أفلام شامل، يشمل مرحلة ما قبل الإنتاج والتصوير وما بعد الإنتاج. ننتج محتوى تلفزيوني وإذاعي جذاب، ونطور محتوى للمنصات الإلكترونية والحملات الرقمية.",
    },
    {
      title: "إدارة الفعاليات والمؤتمرات الصحفية",
      description:
        "تخطيط وتنفيذ المؤتمرات الصحفية وإطلاق المنتجات والفعاليات الإعلامية. نتولى جميع الجوانب اللوجستية والتنسيق الإعلامي لضمان تغطية ناجحة.",
    },
    {
      title: "التدريب الإعلامي والتحضير",
      description:
        "جلسات تدريبية احترافية للمتحدثين الرسميين، تجهيزهم للمقابلات الإعلامية والظهور العام مع إحاطات شاملة وتدريب عملي.",
    },
    {
      title: "الخدمات الاستشارية",
      description:
        "استشارات خبيرة في الاستراتيجية الإعلامية، وتموضع العلامة التجارية، وتخطيط الاتصال للمساعدة في تحقيق أهداف مؤسستك.",
    },
  ],
};
