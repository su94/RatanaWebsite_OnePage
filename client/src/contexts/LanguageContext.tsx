...
const translations: Translations = {
  en: {
    ...
    "services.strategicPlanning":
      "Developing and implementing strategic media plans that are aligned with your business objectives. We provide expert advice on media engagement strategies to optimize coverage and visibility, ensuring your brand gets the attention it deserves.",
    ...
    "services.pressReleases":
      "Crafting and distributing press releases to announce news and events. We also create comprehensive media kits to provide journalists with all the information they need.",
    "services.mediaOutreach":
      "Developing and maintaining relationships with key media contacts to secure positive coverage and build brand awareness. We proactively pitch stories and build strong relationships with journalists and influencers.",
    "about.title": "About Ratana",
    "ourStory.title": "Our Story",
    "ourStory.content":
      '"Ratana" is an ancient Jordanian Arabic name that was used by the Nabateansand it is originally "Ratana Al-Nabata". The Nabateans, with time, developed their own dialect that distinguished them from others.',
    "about.content": `
      <p>
    ...
    "customers.subtitle": "Trusted by leading organizations",
    ...
    "footer.description":
      "Professional consulting services helping businesses achieve their full potential through strategic planning and operational excellence.",
  ...
  ar: {
    ...
    "services.strategicPlanning":
      "تطوير وتنفيذ خطط إعلامية استراتيجية تتماشى مع أهداف عملك. نحن نقدم النصيحة المتخصصة حول استراتيجيات التعامل مع وسائل الإعلام لتعزيز التغطية والظهور، مما يضمن أن يحصل علامتك التجارية على الانتباه الذي تستحقه.",
    "services.contentCreation":
      "ابتكار روايات جذابة للويب والطباعة والوسائط الرقمية. نحن ننتج مقاطع فيديو عالية الجودة من الفكرة إلى القطع النهائي، نصمم رسومات بصرية مثيرة للوسائط المختلفة، ونلتقط صورًا تحكي قصة. بالإضافة إلى ذلك، نخلق رسوم متحركة جذابة مصممة لجمهور متنوع.",
    "services.crisisCommunication":
      "تطوير وتنفيذ استراتيجيات اتصال الأزمة لإدارة وتخفيف الانتقادات السلبية. نحن نقدم الدعم الفوري والرسائل خلال الأزمات لحماية واستعادة سمعة علامتك التجارية.",
    "services.marketing":
      "تنفيذ استراتيجيات رقمية فعالة، مثل SEO وPPC وإدارة وسائل التواصل الاجتماعي. نحن أيضًا نقوم بإنشاء إعلانات مطبوعة ومؤثرة في الهواء الطلق والبث لتعزيز رؤية وعائد علامتك التجارية.",
    "services.consultation":
      "إنتاج استراتيجيات إعلامية مصممة لتلبية أهداف العميل وتقديم المشورة حول تموقع العلامة التجارية والهوية. نحن أيضًا نقوم بإجراء تحليل شامل للسوق لإبلاغ استراتيجيات المحتوى، مما يضمن أن تتألق علامتك التجارية في السوق.",
    "services.mediaTraining":
      "إجراء جلسات تدريب إعلامي لإعداد المتحدثين أمام وسائل الإعلام لمقابلاتهم وظهورهم العلني. نحن نقدم إحاطات مفصلة وجلسات تمرينية لضمان الاتصال الواضح والواثق والفعال.",
    "services.eventManagement":
      "تخطيط وتنفيذ الأحداث الإعلامية، مثل المؤتمرات الصحفية وإطلاق المنتجات والإعلانات الشركاتية. نحن ننسق جميع اللوجستيات ونُدير حضور وسائل الإعلام لضمان نجاح الأحداث والتغطية الجيدة.",
    "services.mediaProduction":
      "إنتاج أفلام شامل، بما في ذلك ما قبل الإنتاج والتصوير وما بعد الإنتاج. نحن ننتج محتوى تلفزيوني وإذاعي مثير، بالإضافة إلى تطوير محتوى للمنصات عبر الإنترنت والحملات الرقمية.",
    "services.monitoring":
      "مراقبة التغطية الإعلامية والمشاعر العامة المتعلقة بمنظمتك بشكل مستمر. نحن نقدم تقارير وتحليلات مفصلة لمتابعة فعالية الاستراتيجيات الإعلامية وتحديد الفرص للتحسين.",
    "services.pressReleases":
      "صياغة وتوزيع البيانات الصحفية لإعلان الأخبار والأحداث. نحن أيضًا نبدأ في إنشاء حزم إعلامية شاملة لتزويد الصحفيين بجميع المعلومات التي يحتاجونها.",
    "services.mediaOutreach":
      "تطوير وصيانة العلاقات مع جهات الاتصال الإعلامية الرئيسية لضمان التغطية الإيجابية وبناء الوعي بالعلامة التجارية. نحن نقدم قصصًا بالاقتراح وبناء علاقات قوية مع الصحفيين والمؤثرين.",
    ...
    "footer.title": "رتانا للإستشارات الإعلامية",
    "footer.description":
      "خدمات استشارية محترفة تساعد الشركات على تحقيق إمكاناتها الكاملة من خلال التخطيط الاستراتيجي والتميز التشغيلي.",
